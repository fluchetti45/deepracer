...
def print_overall_summary(results, args):
    ...
    # Denominador y etiqueta segun el MODO real (episodios fijos vs hasta --laps vueltas),
    # no el default de --laps: en modo --episodes la fraccion es vueltas/episodios.
    if args.episodes is not None:
