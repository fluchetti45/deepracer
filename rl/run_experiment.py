...
def parse_args():
    ...
    p.add_argument(
        "--drive", default="ackermann", choices=["ackermann", "differential"],
        help="Tipo de conduccion: elige worlds/tracks. Default 'ackermann' en esta rama.",
    )
    p.add_argument(
        "--webots-world", default=None,
        help="World del train. Si se omite, el trainer lo deriva de --drive.",
    )
    p.add_argument(
...
def train_one(args, seed):
    ...
    if args.webots_world:
        cmd += ["--webots-world", args.webots_world]
